"""Tests for the interactive session browser (`drewgent sessions browse`).
...
from drewgent_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """drewgent sessions browse should be parseable."""
        from drewgent_cli.main import main as _main_entry
