"""
Drewgent tool call parser.

Format: <tool_call>{"name": "func", "arguments": {...}}</tool_call>
Based on VLLM's Drewgent2ProToolParser.extract_tool_calls()
"""
...
@register_parser("drewgent")
class DrewgentToolCallParser(ToolCallParser):
    """
    Parser for Drewgent-format tool calls.
