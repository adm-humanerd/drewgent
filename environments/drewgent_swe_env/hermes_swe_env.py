"""
DrewgentSweEnv -- SWE-Bench Style Environment with Modal Sandboxes
...
Usage:
    ...
    run-api
    python environments/drewgent_swe_env.py serve \\
...
class DrewgentSweEnv(DrewgentAgentBaseEnv):
    ...
    name = "drewgent-swe"
    env_config_cls = DrewgentSweEnvConfig

    @classmethod
    def config_init(cls) -> Tuple[DrewgentSweEnvConfig, List[APIServerConfig]]:
        """
        ...
        """
        env_config = DrewgentSweEnvConfig(
            ...
            # Atropos settings
            group_size=4,
            tokenizer_name="NousResearch/DeepDrewgent-3-Llama-3-3B-Preview",
            tool_call_parser="drewgent",
            steps_per_eval=50,
            total_steps=500,
            use_wandb=True,
            wandb_name="drewgent-swe",
        )

        server_configs = [
            APIServerConfig(
                base_url="http://localhost:8000/v1",
                model_name="NousResearch/DeepDrewgent-3-Llama-3-3B-Preview",
