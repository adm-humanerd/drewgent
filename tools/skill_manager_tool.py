...
~/.drewgent/skills/. Existing skills (bundled, hub-installed, or user-created)
...
# All skills live in ~/.drewgent/skills/ (single source of truth)
...
def _find_skill(name: str) -> Optional[Dict[str, Any]]:
    ...
    Searches the local skills dir (~/.drewgent/skills/) first, then any
...
SKILL_MANAGE_SCHEMA = {
    ...
    "description": (
        ...
        "New skills go to ~/.drewgent/skills/; existing skills can be modified wherever they live.\n\n"
